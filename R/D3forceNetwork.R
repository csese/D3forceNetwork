...
#' variable is allowed. An optional \code{Nodesize} variable can be included to 
#' to specify the radius of the nodes.
...
#' @param legend boolean value specifying the creation of a legend using the 
#' grouping names.
